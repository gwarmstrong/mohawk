...
class ConvNetAvg4(BaseModel):
    def __init__(self,
                 n_classes: int,
                 seed: Optional[int] = None,
                 ):
        super(ConvNetAvg4, self).__init__(seed=seed)
        ...
        channels = [4, 16, 256, 1000]  # first has to be 4
...
class ConvNetAvg5(BaseModel):
    def __init__(self,
                 n_classes: int,
                 seed: Optional[int] = None,
                 ):
        super(ConvNetAvg5, self).__init__(seed=seed)
